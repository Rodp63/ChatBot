...
$tema = array("que es", "what is", "como puedo", "que deberia", "podrias", "recomiendas", "como funciona", "quiero aprender", "aprender", "quiero", "como creo", "mejorar");
$clima = array("clima", "temperatura");
$cities = array("arequipa", "nueva york", "los angeles", "seul", "paris", "osaka", "shanghai", "chicago", "sao paulo", "houston", "colonia", "pekin", "washington d.c", "canton", "ciudad de mexico", "singapur", "buenos aires", "milan", "toronto", "rio de janeiro", "san diego", "londres", "miami", "tokio", "brasilia", "alaska", "puno", "cuzco","trujillo");
